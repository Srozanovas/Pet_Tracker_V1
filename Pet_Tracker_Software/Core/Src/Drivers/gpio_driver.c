...
const static sGpioDesc_t gpio_desc_lut[] = {
    ...
    [eGpioPinB0Power4V]     = {.port = GPIOB, .pin = GPIO_PIN_0,    .mode = GPIO_MODE_IT_FALLING,   .speed = GPIO_SPEED_FREQ_LOW,       .pull = GPIO_PULLUP, .alternate = 0,                .interupt_enable = true,    .interupt=0xFF          },
